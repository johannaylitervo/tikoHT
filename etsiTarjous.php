...
if (!$yhteys = pg_connect($y_tiedot))
   die("Tietokantayhteyden luominen epäonnistui.");
    ...
    $kysely = pg_query("SELECT * FROM tyosuoritus WHERE kohdeid = '$kohdeid' AND tyon_tila = 0");
    $rivi = pg_fetch_row($kysely);
    if (empty($rivi))
...
<!--
  ...
  <!--PHPohjelmassa
    ...
    <form action ="naytaTarjous.php" method ="post">
    ...
    <input type="hidden" name="tarjoa" value="jep" />
    <input type="submit" value="Näytä tarjous" />
    </form>
</body>
