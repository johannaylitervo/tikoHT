...
if (!$yhteys = pg_connect($y_tiedot))
  ...
  if (isset($_POST['tarjoa']))
  {
  	//if ($_POST["tyosuoritusid == ''"])
  		//echo "Tyosuoritusid tyhä!";
  	//else
  	//{
      ...
      if (empty($rivi))
          $viesti = "Ei summaa halutuilla tiedoilla!";
      else
      {
        $summa = $rivi[0];
      ...
      $first_row = true;
    	if (empty($rivi))
        	$viesti = "Ei tarvikkeita halutuilla tiedoilla!";
    	else
    	{
      ...
      $rivi = pg_fetch_row($kysely);
      if (empty($rivi))
          $viesti .= "\n Ei työsuorituksia halutuilla tiedoilla!";
      else
      {
      ...
      $rivi = pg_fetch_row($kysely);
      if (empty($rivi))
          $kysely = "Ei summaa halutuilla tiedoilla!";
      else
      {
        $hinta = $rivi[0];
